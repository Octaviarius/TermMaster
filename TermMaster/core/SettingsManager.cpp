...
static QString _appSettingsFileName = "main.yaml";
...
SettingsProxy SettingsManager::application(QString nodePath)
{
    return SettingsProxy(QSettings(appDataDirPath() / _appSettingsFileName, YamlFormat), nodePath);
}
