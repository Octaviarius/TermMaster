...
SettingsDialog::SettingsDialog(Settings config, QWidget* parent) :
...
int SettingsDialog::addEntries(QList<SettingsEntry> entries)
{
    int count = 0;
...
int SettingsDialog::addCategories(QList<SettingsCategory> cats)
{
    int count = 0;
